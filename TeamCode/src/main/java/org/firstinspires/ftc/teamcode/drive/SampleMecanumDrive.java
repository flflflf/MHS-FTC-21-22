...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public SampleMecanumDrive(HardwareMap hardwareMap) {
        ...
        BNO055IMUUtil.remapZAxis(imu, AxisDirection.NEG_X); // TODO: check if this is right
    ...
    @Override
    public Double getExternalHeadingVelocity() { // TODO: check to see if I need to chagne this
